...
class NotificationService {
  ...
  Future<void> initialize() async {
    ...
    // ✅ CORREGIDO: initialize con los parámetros correctos
  ...
  Future<void> scheduleNotification(CalendarEntry entry) async {
    ...
    if (reminderTime.isAfter(now)) {
      ...
      // ✅ CORREGIDO: zonedSchedule con todos los parámetros
  ...
  Future<void> cancelNotification(String entryId) async {
    await _notifications.cancel(entryId.hashCode);
    await _notifications.cancel('${entryId}_now'.hashCode);
  }
